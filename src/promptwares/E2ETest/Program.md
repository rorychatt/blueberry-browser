...
- **Prompt**: The high-level test prompt or goal (e.g., "go to google and search for bananas, a new page should open")
...
1. **Navigate**: If you are not on the correct site (or on an empty/blank page), use the `navigate` action.
